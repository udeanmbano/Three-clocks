...
//Import the StillClock.java class
    ...
    public class Exercise18_14 extends JApplet {
      ...
      private JButton resumeButton, suspendButton;
     ...
     * @param args */
      ...
      public void init() {
       ...
       secondpanel.add(resumeButton = new JButton("Resume All"));
       secondpanel.add(suspendButton = new JButton("Suspend All"));
    ...
    class SwitchBoard extends JPanel {
      ...
      class Clock extends StillClock {
        private final Timer timer = new Timer(1000, new Listener());
